      ...
      cWidget(new CalendarWidget(qApp->desktop()->screenGeometry(), eventSet, this))
{
    ...
    e1->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e1->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e2->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e2->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e3->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e3->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e4->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e4->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e5->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e5->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e6->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e6->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e7->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e7->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e8->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e8->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e9->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e9->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e10->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e10->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e41->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e41->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e42->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e42->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e43->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e43->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e44->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e44->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e45->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e45->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e46->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e46->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e47->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e47->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e48->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e48->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e49->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e49->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e50->setStartTime(Create_time_t::createTime(QDateTime::currentDateTime()));
    e50->setEndTime(Create_time_t::createTime(QDateTime::currentDateTime()));
